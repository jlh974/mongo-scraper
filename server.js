...
//mongoose.connect("mongodb://heroku_q50l0q4z:622dmsdajklf8f5onq4bdbu274@ds163721.mlab.com:63721/heroku_q50l0q4z");
...
app.get("/scrape", function(req, res) {
  ...
  request("http://www.yahoo.com/", function(error, response, html) {
    // Then, we load that into cheerio and save it to $ for a shorthand selector
    var $cheerio = cheerio.load(html);
    // Now, we grab every h2 within an article tag, and do the following:
    $cheerio("article h3").each(function(i, element) {
